...
consignée dans `FEEDBACK-RAW.md` AVANT de chercher un contournement.
...
- Toute observation de friction → `FEEDBACK-RAW.md` immédiatement, avec le
...
- `HYPOTHESES.md` — pistes de feedback à confirmer ou infirmer par test
- `FEEDBACK-RAW.md` — journal de capture brut, en continu
- `FEEDBACK.md` — rapport final, 3 pages, écrit dimanche matin
- `README.md` — trame de soumission
- `scripts/` — connexion, financement des comptes, helper JSON brut

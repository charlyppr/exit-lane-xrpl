...
- **Audit de véracité du journal** (passe finale, entrée [19:35]) :
  **143/143** transactions citées retrouvées on-chain, validées, type et code
  ...
  documentés ici. Rejouable : `node bonus/scripts/_probe-audit-hashes.mjs
  FEEDBACK.md bonus/notes/FEEDBACK-RAW.md README.md bonus/notes/HYPOTHESES.md`.
...
Tenté :
  ...
  encore possible ? Chaîne complète exécutée, `bonus/scripts/test-v11-blocking.mjs`.
...
Run propre et rejouable après correctif du script (`node bonus/scripts/test-v11-blocking.mjs`),
...
Contournement trouvé :
  ...
  `bonus/scripts/steps-4-6.mjs`. ~20 min pour le trouver, par dichotomie sur le montant.
...
Scripts : `bonus/scripts/_probe-shares*.mjs`.
...
Script rejouable : `node bonus/scripts/step-8-secondary.mjs`. Scène complète créée
...
Sévérité : **haute**
Lib : xrpl@4.6.0 · rippled 3.4.0-rc1 · script `bonus/scripts/h1-default.mjs`
...
Repro :
  1. `node bonus/scripts/h1-default.mjs` (décor isolé, ~3 min avec les attentes).
...
Lib : xrpl@4.6.0 · script `bonus/scripts/h1-h3.mjs`
...
Sévérité : **haute**
Lib : xrpl@4.6.0 · rippled 3.4.0-rc1 · script `bonus/scripts/_probe-default-cycle.mjs` + `_probe-pay-blocked.mjs`
...
Lib : xrpl@4.6.0 · rippled 3.4.0-rc1 · script `bonus/scripts/_probe-pay-states.mjs`, `_probe-latepayment.mjs`
...
Sévérité : **haute**
Lib : xrpl@4.6.0 · rippled 3.4.0-rc1 · script `bonus/scripts/_probe-cliffs.mjs`
...
Lib : xrpl@4.6.0 · rippled 3.4.0-rc1 · script `bonus/scripts/_probe-transferable-control.mjs`
...
Sévérité : **haute**
Lib : xrpl@4.6.0 · rippled 3.4.0-rc1 · script `bonus/scripts/_probe-h9-observability.mjs` (lecture seule)
...
2. **`xrpl.js` n'expose aucun transport JSON-RPC.** `Client` est WebSocket
   ...
   une trentaine de lignes, cf. `bonus/scripts/_probe-rpc-fallback.mjs`.
...
Relancer `node bonus/scripts/_probe-rpc-fallback.mjs` (RPC) ou son équivalent WSS.
...
Sévérité : —
Lib : xrpl@4.6.0 · rippled 3.4.0-rc1 · script `bonus/scripts/_probe-audit-hashes.mjs`,
`bonus/scripts/_probe-audit-claims.mjs` (tous deux en lecture seule)
...
Sévérité : —
Lib : xrpl@4.6.0 · Explorer v1.5.0 · script `bonus/deck-source/capture-explorer.mjs`
...
Relevé par `bonus/scripts/_probe-close-times.mjs`.
...
Catégorie : documentation/tutorials
Sévérité : —
Lib : xrpl@4.6.0 · rippled 3.4.0-rc1 · `bonus/scripts/_probe-amendments.mjs`
...
Sévérité : —
Lib : xrpl@4.6.0 · `bonus/scripts/_probe-h9-observability.mjs`, `bonus/scripts/_probe-close-times.mjs`

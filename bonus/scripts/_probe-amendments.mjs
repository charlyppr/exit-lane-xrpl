// Amendments du devnet : ceux qui touchent au lending, aux vaults et aux MPT. Lecture seule.
...
console.log(`total activés: ${all.filter((f) => f.enabled).length} / ${all.length}`);
await c.disconnect();

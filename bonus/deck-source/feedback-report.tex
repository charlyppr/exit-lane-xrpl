...
\hyperlink{f7}{\color{blue}\bfseries 7} & \hyperlink{f7}{A share \tm{Payment} to a new holder returns \tm{tecNO\_AUTH}} & documentation/tutorials & \sevMedium\\
...
\end{tabularx}\par}
\vspace{4pt}
{\noindent\makebox[\linewidth][s]{\fontsize{6.6}{8.4}\selectfont\color{muted}\hs{High}:\space blocks a minimum bar step, or misstates a depositor's risk.\hfill\hs{Medium}:\space costs time or a wrong design, with a workaround.\hfill\hs{Low}:\space documented elsewhere, or cosmetic.}\par}
...
\hs{Docs and explorer} & The docs differ in \hyperlink{f1}{1}, \hyperlink{f2}{2}, \hyperlink{f4}{4}, \hyperlink{f7}{7}, \hyperlink{f8}{8}. The explorer hides a flag name (\hyperlink{f2}{2}) and \tm{Vault} fields (\hyperlink{f4}{4}).\\
\end{tabularx}}
...
% ───────────── 7 ─────────────
\finding{7}{Medium}{documentation/tutorials}{A share \tm{Payment} to a new holder returns \tm{tecNO\_AUTH}}
...
\repro
\begin{steps}
\item Public XRP vault, transferable shares, no freeze. A \tm{Payment} of shares to an account without \tm{MPToken} returns \tm{tecNO\_AUTH} (\repo{bonus/scripts/_probe-shares2.mjs}{\_probe-shares2.mjs}).
...
\tm{validateVaultCreate} in \tm{xrpl@4.6.0} accepts any \tm{WithdrawalPolicy}; 0, 2, 3, 99 and 255 return \tm{temMALFORMED}. & client libraries\\
...
the endpoints in \tm{scripts/config.mjs}. Full runs in the

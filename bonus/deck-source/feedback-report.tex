...
\midrule
The Lending Protocol concept page spells \tm{PrincipleOutstanding} and \tm{depostitor}. & documentation/tutorials\\
\tm{validateVaultCreate} (\tm{xrpl@4.6.0}) accepts any \tm{WithdrawalPolicy}; the ledger takes only 1. & client libraries\\
...
\hs{Limits.} XRP only. Intervals of 60 to 90 s. One build. Hashes on the hackathon devnet, which
may close; to replay, edit \tm{scripts/config.mjs}. Full runs in the

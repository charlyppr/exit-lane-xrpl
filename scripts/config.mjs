...
//
// Endpoints are defined here only. Do not hardcode a URL elsewhere in the
// project, so that every script targets the same network.
...
// See hypothesis H6: use these helpers instead of writing the values by hand.
